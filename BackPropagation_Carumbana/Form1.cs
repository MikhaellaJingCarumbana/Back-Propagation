...
namespace BackPropagation_Carumbana
{
    public partial class Form1 : Form
    {
        ...
        private void lblHN_Click(object sender, EventArgs e)
        {
        ...
        private void gbTraining_Enter(object sender, EventArgs e)
        {

        }

        private void chkKeepInputs_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void dgvInputOutput_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void gbSetup_Enter(object sender, EventArgs e)
        {
